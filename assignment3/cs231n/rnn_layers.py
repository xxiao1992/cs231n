...
def rnn_step_backward(dnext_h, cache):
    ...
    dtanh = dnext_h * (1/np.cosh(np.dot(prev_h, Wh) + np.dot(x, Wx) + b))**2
...
def rnn_forward(x, h0, Wx, Wh, b):
    ...
    h = []
    for x_cur in x:
        next_h, cache = rnn_step_forward(x_cur, prev_h, Wx, Wh, b)
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (a, ai, af, ao, ag, i, f ,o ,g, x, prev_h, prev_c, Wx, Wh, b, next_c, next_h)
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    a, ai, af, ao, ag, i, f ,o ,g, x, prev_h, prev_c, Wx, Wh, b, next_c, next_h = cache
...
def lstm_forward(x, h0, Wx, Wh, b):
    ...
    c = []
    for x_cur in x:
        next_h, next_c, cache = lstm_step_forward(x_cur, prev_h, prev_c, Wx, Wh, b)
        cache_list.append(cache)
        h.append(next_h)
        c.append(next_c)
        prev_h = next_h
...
def lstm_backward(dh, cache):
    ...
    #############################################################################
    T = len(cache)
    a, ai, af, ao, ag, i, f ,o ,g, x, prev_h, prev_c, Wx, Wh, b, next_c, next_h = cache[-1]
    N, D = x.shape
    H = dh.shape[2]
